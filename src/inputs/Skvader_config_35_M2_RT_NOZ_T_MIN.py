...
diam_out    = 0.0254*6.625  #0.1413          # [m]
diam_in     = 0.0254*6.065      #0.1282 # = 0.0254*5.047 sched 40         # [m]

#tmp_height_tank = 0.0254*18.626
#TODO: DECREASE V_ox_tank volume, define operating evelope in doc and size ullage for that envelope
#V_ox_tank   = (0.25*np.pi*(diam_in**2))*tmp_height_tank #0.0208            # [m^3] 0.9 Fill Fraction
#print(f"V_ox_tank: {V_ox_tank} [m^3]")
V_ox_tank = 0.008818 #[m^3]
...
#NOTE BUG: simulating drain!
#A_inj_ox = 0.25 * 3.14159 * (0.0254*.410)**2   # [m^2]
...
d_throat = (0.0254*1.1175)     # [m]
expratio = 6.081354606 #8.413859791     # [m]
